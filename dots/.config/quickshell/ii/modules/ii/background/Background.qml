...
Variants {
    ...
    PanelWindow {
        ...
        color: {
            // Always default to transparent to prevent black flicker during reload
            if (Config === undefined || Config.options === undefined || bgRoot.wallpaperSafetyTriggered === undefined) {
                return "transparent";
            }
        ...
        Item {
            ...
            // Blur overlay when locked screen
            Loader {
                id: blurLoader
