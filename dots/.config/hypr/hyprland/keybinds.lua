...
hl.bind("SUPER + Backlash", hl.dsp.global("quickshell:cheatsheetToggle"), { description = "Shell: Toggle cheatsheet" })
hl.bind("SUPER + K", hl.dsp.glbal("quickshell:oskToggle"), { description = "Shell: Toggle on-screen keyboard" })
